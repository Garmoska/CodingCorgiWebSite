...
description: "When trouble hits, an engineer reaches for the browser console, the logging config, and increasingly AI. A tour of the troubleshooting toolbox — from JAR files and thread dumps to git bisect and the network-level tools that matter when a vendor insists everything works on their side."
publishedDate: 2026-09-14
coverImage: ./_images/post-010.jpg
coverImageAlt: "Coding Corgi as a shaman with a drum, surrounded by petroglyph-style animal drawings"
tags: ["troubleshooting", "debugging", "ai"]
---
